...
const mostraFilmes = (data) =>{
  ...
  for(let i=0;i<filmesDados.results.length;i++){
    ...
    dadosHTML += 
    `<div class="card col-3" id="filmes" style="background-color:black;">
...
const inic =  () =>{
  ...
  let url = "https://api.themoviedb.org/3/search/movie?api_key=5dc5fdaea6948e02e3e4deeca0b3aa6b&language=pt-BR&query="+pesquisa;
